            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                ...
                <div class="space-y-6 lg:space-y-8">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="{{ route('consultation') }}" class="bg-[#FF6B35] text-white px-12 py-3 rounded-full font-bold text-lg hover:bg-[#E55A2B] transition-all duration-300 text-center inline-flex items-center justify-center gap-2" style="font-family: 'Inter', sans-serif; min-width: 280px;">
                            Prendre rendez-vous →
                        </a>
