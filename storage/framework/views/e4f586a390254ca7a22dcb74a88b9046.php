            ...
            <div class="header">
                <div class="header-content">
                    <div class="logo-container">
                        <img src="<?php echo e(asset('images/logodwesta.png')); ?>" alt="DWESTA Logo" />
                    </div>
            ...
            <div class="content">
                <div class="message-info">
                    <div class="info-row">
                        ...
                        <div class="info-value"><strong><?php echo e($name); ?></strong> (<?php echo e($email); ?>)</div>
                    </div>
                    
                    <div class="info-row">
                        <div class="info-label"><strong>Objet</strong></div>
                        <div class="info-value"><?php echo e($subject); ?></div>
                    </div>
                </div>
                
                <div class="message-content">
                    <div class="message-label">Message</div>
                    <div class="message-text"><?php echo e($contactMessage); ?></div>
                </div>
            </div>
...
<?php /**PATH C:\Users\LANDING DIALLO\Desktop\Projects\dewesta\dewesta\resources\views/emails/contact.blade.php ENDPATH**/ ?>