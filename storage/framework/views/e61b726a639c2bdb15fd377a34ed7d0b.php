                ...
                <div class="relative flex justify-center lg:justify-end items-center mt-8 lg:mt-8">
                    ...
                    <div class="relative">
                        ...
                        <div class="relative shadow-2xl hero-rectangle w-[420px] h-[300px] md:w-[450px] md:h-[300px] lg:w-[600px] lg:h-[400px] border-[12px] md:border-[18px] lg:border-[24px] cursor-pointer overflow-hidden rounded-2xl transition-all duration-500 ease-in-out" 
                            ...
                            <img src="<?php echo e(asset('images/cap.png')); ?>" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-8 shadow-xl border border-gray-100 relative overflow-hidden">
                    ...
                    <p class="text-[#666666] text-base leading-relaxed mb-6 text-center">
                        ...
                        <!-- Bouton -->
                        <div class="text-center">
                            <a href="<?php echo e(route('cybersecurite')); ?>" class="text-[#FF6B35] font-semibold hover:text-[#e55a2b] transition-colors duration-300 inline-flex items-center gap-2">
                        En savoir plus →
                        </a>
                        </div>
                    </div>
                ...
                <div class="bg-white p-8 shadow-xl border border-gray-100 relative overflow-hidden">
                    ...
                    <p class="text-[#666666] text-base leading-relaxed mb-6 text-center">
                        ...
                        <!-- Bouton -->
                        <div class="text-center">
                            <a href="<?php echo e(route('iot-ot')); ?>" class="text-[#FF6B35] font-semibold hover:text-[#e55a2b] transition-colors duration-300 inline-flex items-center gap-2">
                        En savoir plus →
                        </a>
                        </div>
                    </div>
                ...
                <div class="bg-white p-8 shadow-xl border border-gray-100 relative overflow-hidden">
                    ...
                    <p class="text-[#666666] text-base leading-relaxed mb-6 text-center">
                        ...
                        <!-- Bouton -->
                        <div class="text-center">
                            <a href="<?php echo e(route('solution-informatique')); ?>" class="text-[#FF6B35] font-semibold hover:text-[#e55a2b] transition-colors duration-300 inline-flex items-center gap-2">
                        En savoir plus →
                        </a>
                        </div>
                    </div>
                ...
                <div class="bg-white p-8 shadow-xl border border-gray-100 relative overflow-hidden">
                    ...
                    <p class="text-[#666666] text-base leading-relaxed mb-6 text-center">
                        ...
                        <!-- Bouton -->
                        <div class="text-center">
                            <a href="<?php echo e(route('conseils')); ?>" class="text-[#FF6B35] font-semibold hover:text-[#e55a2b] transition-colors duration-300 inline-flex items-center gap-2">
                        En savoir plus →
                        </a>
                        </div>
                    </div>
                ...
                <div class="bg-white p-8 shadow-xl border border-gray-100 relative overflow-hidden">
                    ...
                    <p class="text-[#666666] text-base leading-relaxed mb-6 text-center">
                        ...
                        <!-- Bouton -->
                        <div class="text-center">
                            <a href="<?php echo e(route('developpement-applicatif')); ?>" class="text-[#FF6B35] font-semibold hover:text-[#e55a2b] transition-colors duration-300 inline-flex items-center gap-2">
                        En savoir plus →
                        </a>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                ...
                <div class="bg-white p-8 shadow-xl border border-gray-100 relative overflow-hidden">
                    <div class="relative z-10">
                        ...
                        <div class="w-24 h-24 mx-auto mb-6 flex items-center justify-center">
                            <img src="<?php echo e(asset('images/IMG-Fortinet.jpg')); ?>" 
                                 alt="Logo Fortinet" 
                ...
                <div class="bg-white p-8 shadow-xl border border-gray-100 relative overflow-hidden">
                    <div class="relative z-10">
                        <!-- Icône orange -->
                        <div class="w-24 h-24 mx-auto mb-6 flex items-center justify-center">
                            <img src="<?php echo e(asset('images/equipes/IMG-EST.jpg')); ?>" 
                                 alt="Logo ESET" 
                                 class="w-16 h-16 object-cover rounded-xl">
                        </div>
                ...
                <div class="lg:ml-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="bg-white p-6 shadow-xl border border-gray-100 relative overflow-hidden">
                            <div class="relative z-10 flex items-center">
                                <div class="w-20 h-20 overflow-hidden mr-6">
                                    <img src="<?php echo e(asset('images/equipes/IMG_CEO.JPG')); ?>" 
                                         alt="Davesne Yaya" 
                                         class="w-full h-full object-cover"
                                         loading="lazy"
                                         decoding="async">
                        ...
                        <div class="bg-white p-6 shadow-xl border border-gray-100 relative overflow-hidden">
                            <div class="relative z-10 flex items-center">
                                <div class="w-20 h-20 overflow-hidden mr-6">
                                    <img src="<?php echo e(asset('images/equipes/IMG_COO.JPG')); ?>" 
                        ...
                        <div class="bg-white p-6 shadow-xl border border-gray-100 relative overflow-hidden">
                            <div class="relative z-10 flex items-center">
                                <div class="w-20 h-20 overflow-hidden mr-6">
                                    <img src="<?php echo e(asset('images/equipes/IMG_CSO.JPG')); ?>" 
                                         alt="Pamela Denis" 
                                         class="w-full h-full object-cover"
                                         loading="lazy"
                                         decoding="async">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 max-w-6xl mx-auto items-center overflow-hidden rounded-2xl shadow-2xl">
                ...
                <div class="relative group h-[700px] bg-gradient-to-br from-gray-100 to-gray-200">
                    <div class="relative overflow-hidden h-full w-full flex items-center justify-center">
                        ...
                        <img id="contact-image" 
                             src="<?php echo e(asset('images/IMG-contact.jpg')); ?>" 
                ...
                <div class="bg-white p-8 relative overflow-hidden min-h-[700px] flex flex-col">
                    ...
                    <div class="relative z-10 flex flex-col min-h-full">
                            ...
                            <div class="error-notification mb-6">
                                <div class="error-content">
                                    ...
                                    <div class="error-text">
                                        ...
                                        <p class="error-description"><?php echo e(session('error')); ?></p>
                                    </div>
                                </div>
                            </div>
                        <?php endif; ?>
                        ...
                        <form id="contact-form" action="<?php echo e(route('contact.send')); ?>" method="POST" class="flex flex-col h-full space-y-4">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="flex-1">
                                ...
                                <textarea name="message" required 
                                          ...
                                          placeholder="Décrivez votre projet en détail..."><?php echo e(old('message')); ?></textarea>
...
<?php endif; ?><?php /**PATH C:\Users\LANDING DIALLO\Desktop\Projects\dewesta\dewesta\resources\views/home.blade.php ENDPATH**/ ?>