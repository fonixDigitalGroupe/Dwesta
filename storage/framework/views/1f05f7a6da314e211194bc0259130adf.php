...
<head>
    ...
    <title><?php echo e($title ?? 'Dwesta - Solutions Digitales & Cybersécurité en Afrique'); ?></title>
    <meta name="description" content="<?php echo e($description ?? 'DWESTA SAS est une entreprise de services numériques créée par deux ingénieurs africains. Plus de 10 ans d\'expérience en cybersécurité, développement web & mobile, IoT/OT et conseil digital.'); ?>">
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="<?php echo e(asset('images/logodwesta.png')); ?>">
    <link rel="apple-touch-icon" href="<?php echo e(asset('images/logodwesta.png')); ?>">
    
    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo e(url()->current()); ?>">
    <meta property="og:title" content="<?php echo e($title ?? 'Dwesta - Solutions Digitales & Cybersécurité'); ?>">
    <meta property="og:description" content="<?php echo e($description ?? 'DWESTA SAS - Services numériques en Afrique : cybersécurité, développement, IoT/OT'); ?>">
    <meta property="og:image" content="<?php echo e(asset('images/logodwesta.png')); ?>">
    ...
    <meta name="twitter:title" content="<?php echo e($title ?? 'Dwesta - Solutions Digitales & Cybersécurité'); ?>">
    <meta name="twitter:description" content="<?php echo e($description ?? 'Services numériques en Afrique'); ?>">
    <meta name="twitter:image" content="<?php echo e(asset('images/logodwesta.png')); ?>">
    ...
    <?php if(request()->is('cybersecurite')): ?>
        <link rel="preload" as="image" href="<?php echo e(asset('images/cyberaccueil.jpg')); ?>">
    <?php endif; ?>
...
$value = context()->get($__contextArgs[0]); ?>' => 'https://schema.org',
    ...
    <!-- Cookie Banner -->
    <link rel="stylesheet" id="silktide-consent-manager-css" href="<?php echo e(asset('cookie-banner/silktide-consent-manager.css')); ?>">
    <script src="<?php echo e(asset('cookie-banner/silktide-consent-manager.js')); ?>"></script>
    <script>
    ...
    <nav class="bg-white shadow-sm fixed w-full top-0 z-50">
            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <a href="<?php echo e(route('home')); ?>" class="flex items-center space-x-3">
                        <img src="<?php echo e(asset('images/logodwesta.png')); ?>" 
                ...
                <div class="hidden md:flex items-center space-x-6">
                    <a href="<?php echo e(route('home')); ?>" class="text-[#2c2c2c] hover:text-[#F53003] px-3 py-2 text-base font-medium transition-colors">Accueil</a>
                    <a href="<?php echo e(route('home')); ?>#about" class="text-[#2c2c2c] hover:text-[#F53003] px-3 py-2 text-base font-medium transition-colors">À propos</a>
                    <a href="<?php echo e(route('home')); ?>#services" class="text-[#2c2c2c] hover:text-[#F53003] px-3 py-2 text-base font-medium transition-colors">Services</a>
                    <a href="<?php echo e(route('home')); ?>#fournisseur" class="text-[#2c2c2c] hover:text-[#F53003] px-3 py-2 text-base font-medium transition-colors">Partenariats</a>
                    <a href="<?php echo e(route('home')); ?>#contact" class="text-[#2c2c2c] hover:text-[#F53003] px-3 py-2 text-base font-medium transition-colors">Contact</a>
        ...
        <div id="mobile-menu" class="md:hidden hidden bg-white border-t border-gray-200 shadow-lg absolute top-full left-0 right-0 z-50" style="display: none;">
            <div class="px-4 pt-2 pb-3 space-y-1">
                <a href="<?php echo e(route('home')); ?>" class="block px-3 py-2 text-[#2c2c2c] hover:text-[#F53003] hover:bg-gray-50 rounded-md transition-colors">Accueil</a>
                <a href="<?php echo e(route('home')); ?>#about" class="block px-3 py-2 text-[#2c2c2c] hover:text-[#F53003] hover:bg-gray-50 rounded-md transition-colors">À propos</a>
                <a href="<?php echo e(route('home')); ?>#services" class="block px-3 py-2 text-[#2c2c2c] hover:text-[#F53003] hover:bg-gray-50 rounded-md transition-colors">Services</a>
                <a href="<?php echo e(route('home')); ?>#fournisseur" class="block px-3 py-2 text-[#2c2c2c] hover:text-[#F53003] hover:bg-gray-50 rounded-md transition-colors">Partenariats</a>
                <a href="<?php echo e(route('home')); ?>#contact" class="block px-3 py-2 text-[#2c2c2c] hover:text-[#F53003] hover:bg-gray-50 rounded-md transition-colors">Contact</a>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                ...
                <div class="md:col-span-1">
                    ...
                    <ul class="space-y-3">
                        <li><a href="<?php echo e(route('home')); ?>" class="text-gray-300 hover:text-white transition-colors duration-300 text-sm">Accueil</a></li>
                        <li><a href="<?php echo e(route('about')); ?>" class="text-gray-300 hover:text-white transition-colors duration-300 text-sm">À propos</a></li>
                        <li><a href="<?php echo e(route('services')); ?>" class="text-gray-300 hover:text-white transition-colors duration-300 text-sm">Services</a></li>
                        <li><a href="<?php echo e(route('partenariats')); ?>" class="text-gray-300 hover:text-white transition-colors duration-300 text-sm">Partenariats</a></li>
                        <li><a href="<?php echo e(route('contact')); ?>" class="text-gray-300 hover:text-white transition-colors duration-300 text-sm">Contact</a></li>
                    </ul>
                </div>
                ...
                <div class="md:col-span-1">
                    ...
                    <ul class="space-y-3">
                        <li><a href="<?php echo e(route('mentions-legales')); ?>" class="text-gray-300 hover:text-white transition-colors duration-300 text-sm">Mentions légales</a></li>
                        <li><a href="<?php echo e(route('cgu')); ?>" class="text-gray-300 hover:text-white transition-colors duration-300 text-sm">Conditions générales d'utilisation</a></li>
                        <li><a href="<?php echo e(route('politique-confidentialite')); ?>" class="text-gray-300 hover:text-white transition-colors duration-300 text-sm">Politique de confidentialité</a></li>
                        <li><a href="<?php echo e(route('politique-cookies')); ?>" class="text-gray-300 hover:text-white transition-colors duration-300 text-sm">Politique de cookies</a></li>
                    </ul>
                </div>
...
</html><?php /**PATH C:\Users\LANDING DIALLO\Desktop\Projects\dewesta\dewesta\resources\views/components/main-layout.blade.php ENDPATH**/ ?>